...
# install clojupyter
RUN rm -rf .cpcache/ && clojure -A:depstar -m hf.depstar.uberjar clojupyter-standalone.jar && clj -m clojupyter.cmdline install --ident clojure-kernel --jarfile clojupyter-standalone.jar
